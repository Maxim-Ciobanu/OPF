...
for i in 1:10
    ...
    best_solution1, best_cost1, best_models1, base_cost1, total_iterations = decomposed_mpopf_local_search(search_factory, 12, ramping_data, demands)
    ...
    push!(results, (objective_value(search_model.model), best_cost1))
